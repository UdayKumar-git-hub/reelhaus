...
const CoreTeam = () => {
  const teamMembers = [
    ...
    { role: " Events Co-head", name: "Manikanta", year: "3rd yr", icon: <Shield className="w-8 h-8" />, image: "https://i.postimg.cc/Qxy19fm3/mani.jpg", description: "Supporting various club activities and initiatives.", color: "silver" },
     ...
     { role: "Social Media Head", name: "Eshwar Reddy", year: "3rd Yr", icon: <Share2 className="w-8 h-8" />, image: "https://i.postimg.cc/G2Ck39QT/eswar.jpg", description: "Managing social media presence and content strategy.", color: "cyan" },
    ...
    { role: "Logistics and Media", name: "Charan", year: "2nd Yr ECE", icon: <Truck className="w-8 h-8" />, image: "https://i.postimg.cc/02WdGk8h/Charan.jpg", description: "Coordinating logistics and media production.", color: "lime" },
     { role: "Logistics and Media Co-Head", name: "Ashvith", year: "2nd Yr ", icon: <Truck className="w-8 h-8" />, image: "https://i.postimg.cc/cCdvKbrd/ashvitj.jpg", description: "Coordinating logistics and media production.", color: "lime" },
    { role: "Video Editor", name: "Snehas", year: "2nd Yr Aero", icon: <Truck className="w-8 h-8" />, image: "https://i.postimg.cc/4x0P1hRs/snehas.jpg", description: "Bringing our stories to life through video.", color: "lime" },
     { role: "Video Editor and Content Writer", name: "Sri Harsha", year: "2nd Yr AiMl", icon: <Truck className="w-8 h-8" />, image: "https://i.postimg.cc/k4LHGJkr/harsha.jpg", description: "Bringing our stories to life through video.", color: "lime" }
  ];
