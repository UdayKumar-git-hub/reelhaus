...
const CoreTeam = () => {
  const teamMembers = [
    ...
    { role: " Events Co-head", name: "Manikanta", year: "3rd yr", icon: <Shield className="w-8 h-8" />, image: "https://i.postimg.cc/tJ0X7gGq/brahmini.jpg", description: "Supporting various club activities and initiatives.", color: "silver" },
     { role: " Events Co-head", name: "M.Sridhanya Reddy", year: "2nd Yr IT", icon: <Shield className="w-8 h-8" />, image: "https://i.postimg.cc/tJ0X7gGq/brahmini.jpg", description: "Supporting various club activities and initiatives.", color: "silver" },
