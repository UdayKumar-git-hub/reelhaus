...
const Home = () => {
  ...
  return (
    <div className="pt-16 min-h-screen bg-black text-white">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center mb-16 px-4">
          <motion.h1
            ...
            className="text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-500 mb-6"
          >
            Reel HausClub
          </motion.h1>
          <motion.p
      ...
      {/* Remaining sections untouched for now - will update next */}
